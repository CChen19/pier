...
const EFFICIENCY_KNOBS: readonly ConfigKnob[] = [
  ...
  { plane: 'efficiency', key: 'onlineContextCompact.cacheWriteReadRatio', kind: 'string', defaultValue: 'auto', envVar: 'PI_HERDR_CACHE_RATIO', impact: 'KV cache write/read cost ratio; auto derives from model cost', docRef: 'docs/efficiency-trial.md' },
  ...
  { plane: 'efficiency', key: 'onlineContextCompact.keepRecentTokens', kind: 'number', defaultValue: 20000, min: 1000, impact: 'Native compaction tail window; inherited from pi unless set here', docRef: 'docs/rfc-sol-pi-absorption.md' },
